...
import { VnSortField, VN_SORT_FIELDS } from '@/api/models/queryOptions/vn/vnSortField';
import { VnDevelopmentStatus, VN_DEV_STATUSES } from '@/api/models/vn/developmentStatus';
import { VnLength, VN_LENGTHS } from '@/api/models/vn/length';
import { ButtonGroup } from '@/components/ButtonGroup/ButtonGroup';
import { ControlWrapper } from '@/components/ControlWrapper/ControlWrapper';
import { SortDirectionControl } from '@/components/SortDirection/SortDirection';
  ...
  return (
    <div className="flex flex-col gap-4">
      <div className="flex w-full flex-1 items-end gap-4">
        ...
        <SearchPopover>
          <div className="flex w-full flex-row gap-8 pb-1">

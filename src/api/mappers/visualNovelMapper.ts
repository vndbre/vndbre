 ...
 * @param dto Dto.
 */
function mapVisualNovelLengthFromDto(dto: VisualNovelDto['length']): VisualNovel['length'] {
  if (dto === null) {
    return null;
  }
 ...
 * @param dto Dto.
 */
function mapVisualNovelRelatedAnimeFromDto(dto: VisualNovelDto['anime']): VisualNovel['anime'] {
  return dto.map(animeDto => ({
    id: animeDto.id,
 ...
 * @param dto Dto.
 */
function mapVisualNovelRelatedFromDto(dto: VisualNovelDto['relations']): VisualNovel['relations'] {
  return dto.map(relationDto => ({
    id: relationDto.id,
 ...
 * @param dto Dto.
 */
function mapVisualNovelStaffFromDto(dto: VisualNovelDto['staff']): VisualNovel['staff'] {
  return dto.map(staffDto => ({
 ...
 * @param dto Dto.
 */
function mapVisualNovelScreenshotsFromDto(dto: VisualNovelDto['screens']): VisualNovel['screens'] {
  return dto.map(screenShotDto => ({
 ...
 */
function magTagsFromDto(dto: VisualNovelDto['tags']): VisualNovel['tags'] {
  return dto.map(tag => ({
    id: tag[0],
    score: tag[1],
    spoilerLevel: tag[2],
...
export namespace VisualNovelMapper {
   ...
   */
  export function fromDto(dto: VisualNovelDto): VisualNovel {
    return {
      id: dto.id,
      title: dto.title,

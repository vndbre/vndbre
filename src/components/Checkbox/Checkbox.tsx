...
const CheckboxComponent: FC<Props> = (
  ...
  <RadixCheckbox.Root
    ...
    {...props}
    className={clsx('rounded-xs border-border relative h-4 w-4 border-2 align-middle', className)}
  >
    <RadixCheckbox.Indicator asChild className="text-primary absolute left-0 top-[-2px]">

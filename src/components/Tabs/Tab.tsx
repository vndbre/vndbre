...
const TabComponent: FC<TabProps> = ({
  ...
  <RadixTabs.Trigger
    ...
    disabled={isDisabled}
  >
    <div className="border-primary-500 pointer-events-none rounded px-3 py-2 leading-6 hover:bg-gray-200 group-data-[disabled]:bg-transparent group-data-[disabled]:text-gray-400">
      {children}
    </div>
